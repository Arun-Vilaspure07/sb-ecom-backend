...
public interface ProductService {
    ...
    ProductDTO updateProduct(Long productId, ProductDTO productDTO, String role);

    ProductDTO deleteProduct(Long productId, String role);

    ProductDTO updateProductImage(Long productId, MultipartFile image, String role) throws IOException;
